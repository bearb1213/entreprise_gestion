...
public class UtilisateurController {
    ...
    public Map<String, Object> me(Authentication authentication) {
        ...
        // 🔥 AJOUT : Récupérer l'utilisateur complet depuis la base
        try {
            // Utilisez votre service pour récupérer l'utilisateur par login
            Map<String, Object> userInfo = utilisateurService.getUtilisateurInfo(login);
            
            // Combiner les informations
            Map<String, Object> response = new HashMap<>();
            response.put("id", userInfo.get("id")); // L'ID de la table utilisateur
            response.put("login", login);
            response.put("roles", authentication.getAuthorities());
            response.put("userType", userType);
            response.put("departement", userInfo.get("departement"));
            response.putAll(userInfo);
            
            System.out.println("✅ User info with ID: " + response);
            return response;
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping("/rh")
    public ResponseEntity<?> getUtilisateursRH() {
        try {
            Map<String, Object> result = utilisateurService.getUtilisateursRH();
