 ...
 */
    ...
    @GetMapping("/mon-departement/actifs")
    public ResponseEntity<List<BesoinDTO>> getBesoinsActifsMonDepartement() {
        try {
            List<BesoinDTO> besoins = besoinService.getBesoinsActifsMonDepartement();
            return ResponseEntity.ok(besoins);
        } catch (Exception e) {
