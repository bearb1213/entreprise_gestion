...
=======
    ...
    public List<Object> getQuestions(
            @RequestParam("id_dept") Integer deptId, 
            @RequestParam("id_metier") Integer metierId,
            @RequestParam("candidatureId") Integer candidatureId) {  // Ajouter ce paramètre
...
<<<<<<< Updated upstream
=======
            candidatureService.updateStatutCandidature(idCandidature,1);
>>>>>>> Stashed changes
