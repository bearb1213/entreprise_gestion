...
const Dashboard = () => {
  ...
  const handlePostuler = async (annonce) => {
    ...
    try {
      ...
      // Optionnel : marquer visuellement que l'annonce a été postulée
      // setAnnonces(prev => prev.map(a => 
      //   a.id === annonce.id ? { ...a, alreadyApplied: true } : a
      // ));
  ...
  const canPostulate = (annonce) => {
    // Vérifier si l'annonce est publiée et a des postes disponibles
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h2 className="text-3xl font-bold text-gray-800">Nos Annonces</h2>
                ...
                <Card
                  ...
                  footer={
                    <div className="w-full">
                      ...
                      <CardActions>
                        <CardButton 
                          variant={canPostulateAnnounce ? "primary" : "secondary"}
                          onClick={() => handlePostuler(annonce)}
                          disabled={isPostulating || !canPostulateAnnounce}
                          className="flex-1"
                        >
                          {isPostulating ? (
                            ...
                            canPostulateAnnounce ? 'Postuler' : 'Non disponible'
                          )}
                        </CardButton>
                        <CardButton 
                          variant="secondary"
